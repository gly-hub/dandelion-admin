module dandelion-admin-server

go 1.20

replace github.com/team-dandelion/go-dandelion v1.3.0 => ../../go-dandelion

require (
	github.com/gly-hub/dandelion-plugs v0.0.0-20240416021220-06a23dda6a2b
